...
namespace  AbcBooks.Web.Areas.Identity.Pages.Account.Manage
{
    ...
    public static class ManageNavPages
    {
        ...
        public static string Referral => "Referrals";
        ...
        public static string AddressNavClass(ViewContext viewContext) => PageNavClass(viewContext, Addresses);
        public static string WalletNavClass(ViewContext viewContext) => PageNavClass(viewContext, Wallet);
        public static string ReferralNavClass(ViewContext viewContext) => PageNavClass(viewContext, Referral);
